...
echo -e "${GREEN}=============================================${NC}"
echo -e "${YELLOW}Para se conectar à VM, use: ssh $ADMIN_USERNAME@$PUBLIC_IP${NC}"
echo -e "${YELLOW}Execute o próximo script para instalar o Docker: ./install_docker.sh${NC}"
